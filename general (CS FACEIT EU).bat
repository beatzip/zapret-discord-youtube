...
--filter-udp=10000-65535 --dpi-desync=fake --dpi-desync-autottl=1 --dpi-desync-repeats=2 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_game.bin" --new ^
